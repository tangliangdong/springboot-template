...
import flybear.hziee.app.mapper.AttendactivityMapper;
...
@Service
public class AttendactivityService {

    @Autowired
    private AttendactivityMapper mapper;
    
    @Autowired
	private SqlRunner sqlRunner;

    public List<Attendactivity> findAll() {
    ...
    public Attendactivity findById(Integer id){
		return mapper.selectByPrimaryKey(id);
	}
	
	public Integer update(Attendactivity entity) throws Exception{
		return mapper.updateByPrimaryKey(entity);
	}

    public Integer save(Attendactivity entity) {
        return mapper.insert(entity);
    }

    public Map<String, Object> getUIGridData(Map<String, Object> where, Map<String, String> pageMap) {
        SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Attendactivity.class);
	...
	public boolean attendactivityIsExist(String key){
			SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Attendactivity.class);
