...
import flybear.hziee.app.mapper.ActivitysMapper;
...
public class ActivitysService {
    ...
    @Autowired
    private ActivitysMapper mapper;
	...
	public Integer update(Activitys entity) throws Exception{
		return mapper.updateByPrimaryKey(entity);
	}

    public Integer save(Activitys entity) {
        return mapper.insert(entity);
    }

    public Map<String, Object> getUIGridData(Map<String, Object> where, Map<String, String> pageMap) {
        SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Activitys.class);
	...
	public boolean activitysIsExist(String key){
			SQLBuilder sqlBuilder = SQLBuilder.getSQLBuilder(Activitys.class);
